---
url: https://developers.eduzz.com/reference/webhook/alpaclass-student-course-finished
title: Eduzz Developers - Webhook - AlpaClass - Alunos - Aluno finalizou o curso
crawledAt: 2026-02-02T17:55:08.239Z
---

# Eduzz Developers - Webhook - AlpaClass - Alunos - Aluno finalizou o curso
...
5.  Aluno finalizou o curso
    

# Aluno finalizou o curso

Notifica o quando o aluno finalizou o curso

**Evento:**

alpaclass.student\_course\_finished
...
Nome do evento (student\_course\_finished)
...
[![Swagger Logo](/_next/image?url=%2Flogos%2Fswagger.webp&w=256&q=75 "Swagger Webhook Reference")](/swagger#/webhooks/postalpaclass_student_course_finished)
...
3  "event": "alpaclass.student_course_finished",
...
Anterior**Aluno favoritou a aula**

](/reference/webhook/alpaclass-student-lesson-marked-as-favorite)[

Próxima**Aluno finalizou um módulo**
